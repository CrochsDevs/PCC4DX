...
<body>
    <div class="gov-container">
        <div class="gov-header">
            <img src="images/pcc-seal.png" alt="Government Seal" class="gov-seal">
            <div class="gov-title">
            ...
            <form id="passwordRecoveryForm" class="gov-form">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="govEmail" name="email" required 
                           placeholder="Enter your registered government email">
                    <small class="form-text">Enter the email associated with your government account</small>
                </div>
                ...
                <div class="security-check">
                    <div class="captcha-container">
                        ...
                        <div class="captcha-box">PCC-2023</div>
                        <input type="text" placeholder="Enter the text above" required>
                    </div>
                </div>
                ...
                <div class="form-footer">
                    <a href="/login" class="gov-link">
                        <i class="icon-arrow-left"></i> Back to Login
                    </a>
                    <span class="help-text">Need assistance? Contact <a href="mailto:helpdesk@pcc.gov.ph">IT Helpdesk</a></span>
                </div>
            </form>
        </div>

        <footer class="gov-footer">
            <p>Official Government System • Secure Portal v2.4</p>
            <p>© 2023 Philippine Carabao Center. All rights reserved.</p>
        </footer>
    </div>
</body>
</html>