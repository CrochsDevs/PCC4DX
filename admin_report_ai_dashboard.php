...
<head>
    ...
    /* Week-based alternating colors */
        ...
        .title {
        font-size: 1.875rem; /* roughly text-3xl */
        font-weight: bold;
        color: #3730a3; /* similar to text-indigo-800 */
        padding-left: 1rem;
        padding-top: 2rem;
        ...
        .subtitle {
        color: #4B5563; /* similar to text-gray-600 */
        padding-left: 1rem;
        }
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <header class="mb-10">
            <div class="flex justify-between items-center">
                <div>
            <h1 class="title">Artificial Insemination</h1>
        <p class="subtitle">AI-generated reports are updated daily to provide accurate and timely insights.</p>
