    ...
    <!-- Total AI -->
        ...
        <div class="bg-white p-6 rounded-xl shadow-md card-hover fade-in">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-yellow-600">320</h3>
                </div>
            ...
            <div class="mt-4">
                <div class="flex justify-between text-sm text-gray-500">
                    <span>Remaining</span>
                    <span>320/12,784</span>
                </div>
                <div class="progress-bar mt-1">
                    <div class="progress-fill bg-yellow-600" style="width: 97.5%"></div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-md card-hover fade-in">
            <div class="flex justify-between items-center">
                <div>
                    <p class="text-gray-500 font-medium">Average Accomplishment</p>
