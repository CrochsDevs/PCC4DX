    ...
    <body class="bg-gray-50 font-sans">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                <div class="bg-white rounded-xl shadow-sm p-6 card-hover transition fade-in">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="w-full bg-gray-200 rounded-full h-2.5 mt-2 overflow-hidden">
                            <div class="bg-green-500 h-2.5 rounded-full" style="width: <?= min($overallPercentage, 100) ?>%"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 card-hover transition fade-in">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="w-full bg-gray-200 rounded-full h-2.5 mt-2 overflow-hidden">
                            <div class="bg-blue-500 h-2.5 rounded-full" style="width: <?= min($overallPercentage, 100) ?>%"></div>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap w-32">
                                    <div class="flex items-center">
                                        <div class="w-full bg-gray-200 rounded-full h-2.5 mr-2 overflow-hidden">
                                            ...
                                            ?>" style="width: <?= min($center['percent'], 100) ?>%"></div>
                                        </div>
        ...
        // Function to abbreviate center names
        ...
        const centerChart = new Chart(centerCtx, {
            type: 'bar',
            data: {
                labels: centers.map(c => abbreviate(c.name)), // Use abbreviation
                datasets: [
                    {
